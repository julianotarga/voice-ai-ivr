...
class RealtimeConfig:
    ...
    vad_eagerness: str = "high"  # high responde rápido (só semantic_vad)
    ...
    # G.711 μ-law nativo - requer mod_audio_stream NETPLAY FORK
    audio_format: str = "g711_ulaw"  # G.711 μ-law (menor latência)
